...
namespace Index_Prototype {
    ...
    public partial class DatabaseDataSet3 : global::System.Data.DataSet {
        ...
        public partial class AttendanceDataTable : global::System.Data.TypedTableBase<AttendanceRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public AttendanceRow AddAttendanceRow(int PRESENT, int LATE, int ABSENT) {
        ...
        public partial class AttendanceRow : global::System.Data.DataRow {
            ...
            public int LATE {
                get {
                    try {
                        return ((int)(this[this.tableAttendance.LATEColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            public int ABSENT {
                get {
                    try {
                        return ((int)(this[this.tableAttendance.ABSENTColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace Index_Prototype.DatabaseDataSet3TableAdapters {
    ...
    public partial class AttendanceTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        COUNT(CASE WHEN status = 0 THEN 1 END) AS PRESENT, COUNT(CASE WHEN status = 1 THEN 1 END) AS LATE, COUNT(CASE WHEN status = 2 THEN 1 END) AS ABSENT
FROM            Attendance
WHERE        (subjectId = @subjectId) AND (studentId = @studentId)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@subjectId", global::System.Data.SqlDbType.VarChar, 36, global::System.Data.ParameterDirection.Input, 0, 0, "subjectId", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@studentId", global::System.Data.SqlDbType.VarChar, 11, global::System.Data.ParameterDirection.Input, 0, 0, "studentId", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(DatabaseDataSet3.AttendanceDataTable dataTable, string subjectId, string studentId) {
        ...
        public virtual DatabaseDataSet3.AttendanceDataTable GetData(string subjectId, string studentId) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((subjectId == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            ...
            DatabaseDataSet3.AttendanceDataTable dataTable = new DatabaseDataSet3.AttendanceDataTable();
