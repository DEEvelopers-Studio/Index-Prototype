...
select Students.* from Students LEFT JOIN StudentSubjectData ON Students.uid = StudentSubjectData.uid where StudentSubjectData.subjectId = '84cd2e3a-f898-4bbf-ade4-921ee59abe37' Order By lastName ASC
