...
SELECT COUNT(CASE WHEN status = 0 THEN 1 END) as PRESENT,COUNT(CASE WHEN status = 1 THEN 1 END) as LATE,COUNT(CASE WHEN status = 2 THEN 1 END) as ABSENT FROM Attendance where subjectId='84cd2e3a-f898-4bbf-ade4-921ee59abe37' AND studentId = '02000129455'
